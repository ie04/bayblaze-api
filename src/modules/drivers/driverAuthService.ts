...
async function sendSignupCode(email: string, code: string, ttlMinutes: number) {
  ...
  await resend.emails.send({
    ...
    html: [
      ...
      "<div style=\"max-width:520px;margin:0 auto;background:#ffffff;border:1px solid #d8ded2;border-radius:18px;overflow:hidden;box-shadow:0 18px 44px rgba(17,19,15,0.12)\">",
      ...
      "<h1 style=\"margin:0;color:#000000;font-size:28px;line-height:1.1;font-weight:800\">Verify your email</h1>",
      "</div>",
      "<div style=\"padding:22px 24px 26px\">",
      "<p style=\"margin:0 0 14px;color:#11130f;font-size:16px\">Use this code to finish setting up your driver account.</p>",
      `<p style="font-family:Jost,Avenir,Montserrat,Arial,sans-serif;font-size:36px;font-weight:800;letter-spacing:8px;margin:0 0 16px;padding:16px 18px;background:#f6f8f5;border:1px solid #d8ded2;border-radius:14px;text-align:center;color:#000000">${code}</p>`,
      `<p style="margin:0;color:#585858;font-size:15px">This code expires in ${ttlMinutes} minutes.</p>`,
      "</div>",
      "</div>",
      "</div>",
    ].join(""),
